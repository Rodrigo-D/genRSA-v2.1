    ...
    public void encrypt() {
        ...
        for(iterator=0; iterator<size; iterator++){
            ...
            if (originalNum!=null){
                ...
                this.DCprint.cipheredData(cipheredNum);
            }            
        }        
    }
    ...
    public void decrypt() {
        ...
        for(iterator=0; iterator<size; iterator++){
            ...
            if (cipheredNum != null){
                ...
                this.DCprint.decipheredData(decipheredNum);
            }            
        }     
    }
    ...
    private boolean processNumbers(String lines[], boolean isOriginal){
        ...
        while (lineIterator < linesNum && processedIterator < linesNum+10){
            ...
            try{
                ...
                this.errorDialog.DeCipherData(this.radix);
                return false;
            }
            ...
            //QUE SE CIFREN TODOS, PARA UN CORRECTO CIFRADO INTRODUCIR UN NUMERO MENOR AL MODULO EN CADA LINEA
            else {
                modified=true;
       ...
       this.DCprint.OriginalData(processedNumbers, isOriginal);
